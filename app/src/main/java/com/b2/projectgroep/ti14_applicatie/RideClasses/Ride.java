...
public class Ride implements Serializable {
    ...
    public static HashMap<String, Ride> getTestRides() {
        ...
        toReturn.put("Cobra", new Ride(R.string.testRide_black_mamba_title, R.string.testRide_black_mamba_type, R.string.testRide_black_mamba_information, R.drawable.black_mamba));
